...
| ---------- | ------------------------------- | ------------ | --------------- |
| `type`     | `"" \| "card" \| "border-card"` |              | Тип отображения |
| `addable`  | `boolean`                       | `false`      | Добавление      |
| `editable` | `boolean`                       | `false`      | Редактирование  |
...
| `addIcon` | Содержимое иконки добавления |
...
| `tabAdd`      | Событие добавления                   |
| `tabChange`   | Событие переключения между вкладками |
| `tabClick`    | Событие клика по вкладке             |
| `tabRemove`   | Событие удаление вкладки             |
| `beforeLeave` | Событие ухода с вкладки              |
