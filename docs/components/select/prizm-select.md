...
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------- | --------------------------- |
| `disabled`           | `boolean`                                                                                                                                                          | `false`        | Блокировка селекта          |
| `clearable`          | `boolean`                                                                                                                                                          | `false`        | Очистка селекта             |
| `defaultFirstOption` | `boolean`                                                                                                                                                          | `false`        | Дефолтный выбор селекта     |
| `multiple`           | `boolean`                                                                                                                                                          | `false`        | Множественный выбор селекта |
| `filterable`         | `boolean`                                                                                                                                                          | `true`         | Фильтр селекта              |
| `placeholder`        | `string`                                                                                                                                                           | `Выберите...`  | Placeholder селекта         |
| `noDataText`         | `string`                                                                                                                                                           | `Нет данных`   | Placeholder селекта         |
| `size`               | `small` \| `default` \| `large`                                                                                                                                    | `large`        | Размер селекта              |
| `placement`          | `top` \| `top-start` \| `top-end` \| `bottom` \| `bottom-start` \| `bottom-end` \| `left` \| `left-start` \| `left-end` \| `right` \| `right-start` \| `right-end` | `bottom-start` | Позиция списка селекта      |
| `effect`             | `light` \| `dark`                                                                                                                                                  | `light`        | Размер селекта              |

## Slots

| Название  | Описание                            |
| --------- | ----------------------------------- |
| `default` | Основное содержимое части селекта   |
| `header`  | Содержимое header спика             |
| `footer`  | Содержимое footer спика             |
| `prefix`  | Содержимое перед селектом           |
| `empty`   | Содержимое когда нет данных селекта |
| `tag`     | Содержимое tag селекта              |
| `loading` | Содержимое загрузки селекта         |
| `label`   | Содержимое заголовка селекта        |

## Events

| Название    | Описание                     |
| ----------- | ---------------------------- |
| `clear`     | Событие очистки селекта      |
| `change`    | Событие изменения селекта    |
| `removeTag` | Событие удаления tag селекта |
